...
public class Phonebook {
	...
	public static void main(String[] args) {
		...
		while (!exit) {
			...
			System.out.println("4) search contact by name (return ArrayList contain Occurrences ");
	...
	public static void addFromFile(ArrayList<Contact> phonebook) {
			...
			try {
				...
				while((line = reader.readLine())!=null) {
					...
					spaceChar = line.indexOf(":");
					bufferContact = new Contact();
					bufferContact.SetName(line.substring(0,spaceChar));
					bufferContact.SetNumber(line.substring(spaceChar));
